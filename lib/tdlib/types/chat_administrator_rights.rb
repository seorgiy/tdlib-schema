module TD::Types
  ...
  #
  # @attr can_manage_chat [Boolean] True, if the administrator can get chat event log, get chat boosts in channels, get
  #   channel members, report supergroup spam messages, see anonymous administrators in supergroups and ignore slow mode.
  ...
  # @attr can_post_stories [Boolean] True, if the administrator can create new channel stories, or edit and delete
  #   posted stories; applicable to channels only.
  # @attr can_edit_stories [Boolean] True, if the administrator can edit stories posted by other users, pin stories and
