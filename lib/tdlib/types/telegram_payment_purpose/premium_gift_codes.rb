module TD::Types
  ...
  #
  # @attr boosted_chat_id [Integer] Identifier of the channel chat, which will be automatically boosted by the users
  #   for duration of the Premium subscription and which is administered by the user; 0 if none.
  ...
  # @attr month_count [Integer] Number of month the Telegram Premium subscription will be active for the users.
