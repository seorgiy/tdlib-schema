module TD::Types
  ...
  # @attr background_custom_emoji_id [Integer] Identifier of a custom emoji to be shown on the reply header background
  #   in replies to messages sent by the chat; 0 if none.
